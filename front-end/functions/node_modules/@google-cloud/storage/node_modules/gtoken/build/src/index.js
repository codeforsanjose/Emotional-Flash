...
var GoogleToken = /** @class */ (function () {
    ...
    GoogleToken.prototype.getTokenAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var mimeType, _a, key, body, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!(!this.key && this.keyFile)) return [3 /*break*/, 8];
                        mimeType = mime.getType(this.keyFile);
                        _a = mimeType;
                        switch (_a) {
                        ...
                        return [3 /*break*/, 7];
                    case 1: return [4 /*yield*/, readFile(this.keyFile, 'utf8')];
                    case 2:
                        key = _d.sent();
                        body = JSON.parse(key);
                    ...
                    case 3:
                        ...
                        this.ensureEmail();
                        _b = this;
                        return [4 /*yield*/, readFile(this.keyFile, 'utf8')];
                    case 4:
                        _b.key = _d.sent();
                        return [3 /*break*/, 8];
                    case 5:
                        ...
                        this.ensureEmail();
                        _c = this;
                        return [4 /*yield*/, google_p12_pem_1.getPem(this.keyFile)];
                    case 6:
                        _c.key = _d.sent();
                        return [3 /*break*/, 8];
                    case 7: throw new ErrorWithCode('Unknown certificate type. Type is determined based on file extension.  Current supported extensions are *.json, *.pem, and *.p12.', 'UNKNOWN_CERTIFICATE_TYPE');
                    case 8: return [2 /*return*/, this.requestToken()];
                }
            });
        });
    };
