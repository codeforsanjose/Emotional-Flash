...
<html lang="en">
<head>
    <title>Code coverage report for core/view/filter/RangedFilter.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">core/view/filter</a> RangedFilter.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  updateFullNode(
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (newSnap.isLeafNode()) {
      // Make sure we have a children node with the correct index, not a leaf node;
<span class="cstat-no" title="statement not covered" >      newSnap = ChildrenNode.EMPTY_NODE;</span>
    }
