...
<html lang="en">
<head>
    <title>Code coverage report for core/view/View.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">core/view</a> View.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1736x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1736x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  removeEventRegistration(
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (cancelError) {
<span class="cstat-no" title="statement not covered" >      assert(</span>
        eventRegistration == null,
        'A cancel should cancel all event registrations.'
      );
      const path = <span class="cstat-no" title="statement not covered" >this.query_.path;</span>
<span class="cstat-no" title="statement not covered" >      this.eventRegistrations_.forEach(<span class="fstat-no" title="function not covered" >function(</span>registration) {</span>
<span class="cstat-no" title="statement not covered" >        cancelError /** @type {!Error} */ = cancelError;</span>
        const maybeEvent = <span class="cstat-no" title="statement not covered" >registration.createCancelEvent(cancelError, path);</span>
<span class="cstat-no" title="statement not covered" >        if (maybeEvent) {</span>
<span class="cstat-no" title="statement not covered" >          cancelEvents.push(maybeEvent);</span>
        }
      });
    }
&nbsp;
