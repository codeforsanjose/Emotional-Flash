...
<html lang="en">
<head>
    <title>Code coverage report for core/view/filter/IndexedFilter.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">core/view/filter</a> IndexedFilter.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">12x</span>
<span class="cline-any cline-yes">1392x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">12x</span>
...
&nbsp;
  updateChild(
    ...
    if (
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (oldChild.isEmpty() == newChild.isEmpty()) {
        // Nothing changed.
&nbsp;
...
&nbsp;
    if (optChangeAccumulator != null) {
      if (newChild.isEmpty()) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (snap.hasChild(key)) {
...
<span class="cstat-no" title="statement not covered" >          assert(</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (snap.isLeafNode() &amp;&amp; newChild.isEmpty()) {
...
&nbsp;
  ...
  updatePriority(oldSnap: Node, newPriority: Node): Node {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (oldSnap.isEmpty()) {
