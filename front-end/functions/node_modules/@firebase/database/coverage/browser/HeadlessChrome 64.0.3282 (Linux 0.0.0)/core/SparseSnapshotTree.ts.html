...
<html lang="en">
<head>
    <title>Code coverage report for core/SparseSnapshotTree.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">core</a> SparseSnapshotTree.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.children_ !== null) {
        const childKey = path.getFront();
        path = path.popFront();
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.children_.contains(childKey)) {
