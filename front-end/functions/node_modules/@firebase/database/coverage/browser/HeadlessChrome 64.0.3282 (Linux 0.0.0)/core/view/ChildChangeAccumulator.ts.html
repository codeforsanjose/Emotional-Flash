...
<html lang="en">
<head>
    <title>Code coverage report for core/view/ChildChangeAccumulator.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">core/view</a> ChildChangeAccumulator.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  trackChildChange(change: Change) {
    ...
    if (oldChange) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (type == Change.CHILD_ADDED &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >oldType == Change.CHILD_REMOVED)</span> {
<span class="cstat-no" title="statement not covered" >        this.changeMap_[childKey] = Change.childChangedChange(</span>
          childKey,
          change.snapshotNode,
...
<span class="cstat-no" title="statement not covered" >        delete this.changeMap_[childKey];</span>
...
<span class="cstat-no" title="statement not covered" >        this.changeMap_[childKey] = Change.childAddedChange(</span>
          childKey,
          change.snapshotNode
        );
      } else <span class="cstat-no" title="statement not covered" >if (</span>
