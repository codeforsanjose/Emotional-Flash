...
<html lang="en">
<head>
    <title>Code coverage report for core/snap/IndexMap.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">core/snap</a> IndexMap.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  get(indexKey: string): SortedMap&lt;NamedNode, Node&gt; | null {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!sortedMap) <span class="cstat-no" title="statement not covered" >throw new Error('No index defined for ' + indexKey);</span>
&nbsp;
