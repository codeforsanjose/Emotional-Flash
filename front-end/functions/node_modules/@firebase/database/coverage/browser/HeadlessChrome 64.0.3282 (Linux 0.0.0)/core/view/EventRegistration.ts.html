...
<html lang="en">
<head>
    <title>Code coverage report for core/view/EventRegistration.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">core/view</a> EventRegistration.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">79.52% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>66/83</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-yes">12x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">466x</span>
<span class="cline-any cline-yes">466x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">466x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  getEventRunner(eventData: CancelEvent | DataEvent): () =&gt; void {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (eventData.getEventType() === 'cancel') {
<span class="cstat-no" title="statement not covered" >      assert(</span>
        this.cancelCallback_,
        'Raising a cancel event on a listener with no cancel callback'
      );
      const cancelCB = <span class="cstat-no" title="statement not covered" >this.cancelCallback_;</span>
...
<span class="cstat-no" title="statement not covered" >        cancelCB.call(ctx, (eventData as CancelEvent).error);</span>
      };
    } else {
...
&nbsp;
   ...
   * @inheritDoc
   */
<span class="fstat-no" title="function not covered" >  createCancelEvent(</span>error: Error, path: Path): CancelEvent | null {
<span class="cstat-no" title="statement not covered" >    if (this.cancelCallback_) {</span>
<span class="cstat-no" title="statement not covered" >      return new CancelEvent(this, error, path);</span>
    } else {
...
&nbsp;
   ...
   */
  matches(other: EventRegistration): boolean {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(other instanceof ValueEventRegistration)) {
...
&nbsp;
  ...
  respondsTo(eventType: string): boolean {
    let eventToCheck =
      eventType === 'children_added' ? <span class="branch-0 cbranch-no" title="branch not covered" >'child_added' </span>: eventType;
    eventToCheck =
      eventToCheck === 'children_removed' ? <span class="branch-0 cbranch-no" title="branch not covered" >'child_removed' </span>: eventToCheck;
  ...
  matches(other: EventRegistration): boolean {
    if (other instanceof ChildEventRegistration) {
      if (!this.callbacks_ || !other.callbacks_) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (otherCount === thisCount) {
          // If count is 1, do an exact match on eventType, if either is defined but null, it's a match.
          //  If event types don't match, not a match
          // If count is not 1, exact match across all
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (otherCount === 1) {
...
<span class="cstat-no" title="statement not covered" >            return every(</span>
              this.callbacks_,
<span class="fstat-no" title="function not covered" >              (</span>eventType, cb) =&gt; <span class="cstat-no" title="statement not covered" >other.callbacks_[eventType] === cb</span>
            );
          }
        }
      }
