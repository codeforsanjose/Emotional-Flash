...
<html lang="en">
<head>
    <title>Code coverage report for core/view/ViewProcessor.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">core/view</a> ViewProcessor.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">89.18% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>206/231</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">82.48% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>113/137</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>201/226</span>
      </div>
    </div>
  </div>
...
<span class="cline-any cline-yes">1326x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1189x</span>
<span class="cline-any cline-yes">1189x</span>
<span class="cline-any cline-yes">1189x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  applyOperation(
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (operation.type === OperationType.LISTEN_COMPLETE) {
...
<span class="cstat-no" title="statement not covered" >      throw assertionError('Unknown operation type: ' + operation.type);</span>
    }
  ...
  private generateEventCacheAfterServerEvent_(
    ...
    if (writesCache.shadowingWrite(changePath) != null) {
      ...
      if (changePath.isEmpty()) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (childKey == '.priority') {
<span class="cstat-no" title="statement not covered" >          assert(</span>
            changePath.getLength() == 1,
            "Can't have a priority with additional path components"
          );
          const oldEventNode = <span class="cstat-no" title="statement not covered" >oldEventSnap.getNode();</span>
<span class="cstat-no" title="statement not covered" >          serverNode = viewCache.getServerCache().getNode();</span>
          // we might have overwrites for this priority
          const updatedPriority = <span class="cstat-no" title="statement not covered" >writesCache.calcEventCacheAfterServerOverwrite(</span>
            changePath,
            oldEventNode,
            serverNode
          );
<span class="cstat-no" title="statement not covered" >          if (updatedPriority != null) {</span>
<span class="cstat-no" title="statement not covered" >            newEventCache = this.filter_.updatePriority(</span>
              oldEventNode,
              updatedPriority
            );
          } else {
            // priority didn't change, keep old node
<span class="cstat-no" title="statement not covered" >            newEventCache = oldEventSnap.getNode();</span>
          }
        } else {
          ...
          if (oldEventSnap.isCompleteForChild(childKey)) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (eventChildUpdate != null) {
...
<span class="cstat-no" title="statement not covered" >              newEventChild = oldEventSnap</span>
                .getNode()
                .getImmediateChild(childKey);
            }
          } else {
...
&nbsp;
  ...
  applyServerOverwrite_(
    ...
    if (changePath.isEmpty()) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (childKey == '.priority') {
<span class="cstat-no" title="statement not covered" >        newServerCache = serverFilter.updatePriority(</span>
          oldServerSnap.getNode(),
          newChildNode
        );
      } else {
...
<span class="cstat-no" title="statement not covered" >              newChild = childNode;</span>
            } else {
...
&nbsp;
    ...
    if (affectedTree.value != null) {
      ...
      if (
        ...
        serverCache.getNode().forEachChild(KEY_INDEX, <span class="fstat-no" title="function not covered" >function(</span>name, node) {
<span class="cstat-no" title="statement not covered" >          changedChildren = changedChildren.set(new Path(name), node);</span>
        });
...
&nbsp;
  ...
  private revertUserWrite_(
    ...
    if (writesCache.shadowingWrite(path) != null) {
      ...
      let newEventCache;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (path.isEmpty() || <span class="branch-1 cbranch-no" title="branch not covered" >path.getFront() === '.priority')</span> {
        let newNode;
        ...
        const childKey = <span class="cstat-no" title="statement not covered" >path.getFront();</span>
        let newChild = <span class="cstat-no" title="statement not covered" >writesCache.calcCompleteChild(</span>
          childKey,
          viewCache.getServerCache()
        );
...
<span class="cstat-no" title="statement not covered" >          newChild = oldEventCache.getImmediateChild(childKey);</span>
        }
<span class="cstat-no" title="statement not covered" >        if (newChild != null) {</span>
<span class="cstat-no" title="statement not covered" >          newEventCache = this.filter_.updateChild(</span>
            oldEventCache,
            childKey,
            newChild,
            path.popFront(),
...
<span class="cstat-no" title="statement not covered" >          newEventCache = oldEventCache;</span>
        }
<span class="cstat-no" title="statement not covered" >        if (</span>
...
<span class="cstat-no" title="statement not covered" >          complete = writesCache.calcCompleteEventCache(</span>
            viewCache.getCompleteServerSnap()
          );
<span class="cstat-no" title="statement not covered" >          if (complete.isLeafNode()) {</span>
<span class="cstat-no" title="statement not covered" >            newEventCache = this.filter_.updateFullNode(</span>
              newEventCache,
              complete,
              accumulator
            );
