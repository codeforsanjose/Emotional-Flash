...
<html lang="en">
<head>
    <title>Code coverage report for core/util/CountedSet.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">core/util</a> CountedSet.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
   ...
   */
  add(item: K, val: V) {
    this.set[item as any] = val !== null ? val : (<span class="branch-1 cbranch-no" title="branch not covered" >true as any);</span>
  }
&nbsp;
  /**
   * @param {!K} key
...
&nbsp;
   ...
   */
  get(item: K): V | void {
    return this.contains(item) ? this.set[item as any] : <span class="branch-1 cbranch-no" title="branch not covered" >undefined;</span>
  }
&nbsp;
  /**
   * @param {!K} item
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  keys(): K[] {</span>
    const keys: K[] = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >    forEach(this.set, <span class="fstat-no" title="function not covered" >(</span>k: K) =&gt; {</span>
