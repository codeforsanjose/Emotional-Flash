...
<html lang="en">
<head>
    <title>Code coverage report for core/WriteTree.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">core</a> WriteTree.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">91.71% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>188/205</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>185/202</span>
      </div>
    </div>
  </div>
...
802
803
804</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">12x</span>
<span class="cline-any cline-yes">2189x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">533x</span>
<span class="cline-any cline-yes">2060x</span>
<span class="cline-any cline-yes">2060x</span>
<span class="cline-any cline-yes">2060x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3259x</span>
<span class="cline-any cline-yes">3259x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    while (removedWriteWasVisible &amp;&amp; i &gt;= 0) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (currentWrite.visible) {
        if (
          i &gt;= idx &amp;&amp;
...
&nbsp;
   ...
   * @return {?Node}
   */
<span class="fstat-no" title="function not covered" >  getCompleteWriteData(</span>path: Path): Node | null {
<span class="cstat-no" title="statement not covered" >    return this.visibleWrites_.getCompleteNode(path);</span>
  }
&nbsp;
  /**
    ...
    if (!writeIdsToExclude &amp;&amp; !includeHiddenWrites) {
      ...
      if (shadowingNode != null) {
        ...
        if (subMerge.isEmpty()) {
          ...
          const layeredCache = completeServerCache || <span class="branch-1 cbranch-no" title="branch not covered" >ChildrenNode.EMPTY_NODE;</span>
          return subMerge.apply(layeredCache);
        }
      }
    } else {
      const merge = this.visibleWrites_.childCompoundWrite(treePath);
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!includeHiddenWrites &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >merge.isEmpty())</span> {
<span class="cstat-no" title="statement not covered" >        return completeServerCache;</span>
      } else {
        // If the server cache is null, and we don't have a complete cache, we need to return null
        <span class="missing-if-branch" title="if path not taken" >I</span>if (
          !includeHiddenWrites &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >          completeServerCache == null </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >          !merge.hasCompleteWrite(Path.Empty)</span>
        ) {
<span class="cstat-no" title="statement not covered" >          return null;</span>
        } else {
...
&nbsp;
  ...
  calcCompleteEventChildren(
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (topLevelSet) {
<span class="cstat-no" title="statement not covered" >      if (!topLevelSet.isLeafNode()) {</span>
        // we're shadowing everything. Return the children.
<span class="cstat-no" title="statement not covered" >        topLevelSet.forEachChild(PRIORITY_INDEX, <span class="fstat-no" title="function not covered" >function(</span></span>
          childName,
          childSnap
        ) {
<span class="cstat-no" title="statement not covered" >          completeChildren = completeChildren.updateImmediateChild(</span>
            childName,
            childSnap
          );
        });
      }
<span class="cstat-no" title="statement not covered" >      return completeChildren;</span>
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (completeServerChildren) {
      ...
      const merge = <span class="cstat-no" title="statement not covered" >this.visibleWrites_.childCompoundWrite(treePath);</span>
<span class="cstat-no" title="statement not covered" >      merge.getCompleteChildren().forEach(<span class="fstat-no" title="function not covered" >function(</span>namedNode) {</span>
<span class="cstat-no" title="statement not covered" >        completeChildren = completeChildren.updateImmediateChild(</span>
          namedNode.name,
          namedNode.node
        );
...
&nbsp;
  ...
  calcEventCacheAfterServerOverwrite(
    ...
    assert(
      existingEventSnap || <span class="branch-1 cbranch-no" title="branch not covered" >existingServerSnap,</span>
      'Either existingEventSnap or existingServerSnap must exist'
    );
    const path = treePath.child(childPath);
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.visibleWrites_.hasCompleteWrite(path)) {
...
&nbsp;
  ...
  private resetTree_() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.allWrites_.length &gt; 0) {
      this.lastWriteId_ = this.allWrites_[this.allWrites_.length - 1].writeId;
    } else {
<span class="cstat-no" title="statement not covered" >      this.lastWriteId_ = -1;</span>
    }
  }
&nbsp;
  /**
    ...
    for (let i = 0; i &lt; writes.length; ++i) {
      ...
      if (filter(write)) {
        ...
        if (write.snap) {
          ...
          } else <span class="missing-if-branch" title="else path not taken" >E</span>if (writePath.contains(treeRoot)) {
        ...
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (write.children) {
          if (treeRoot.contains(writePath)) {
            relativePath = Path.relativePath(treeRoot, writePath);
            ...
            relativePath = Path.relativePath(writePath, treeRoot);
            <span class="missing-if-branch" title="if path not taken" >I</span>if (relativePath.isEmpty()) {
<span class="cstat-no" title="statement not covered" >              compoundWrite = compoundWrite.addWrites(</span>
                Path.Empty,
                write.children
              );
            } else {
...
<span class="cstat-no" title="statement not covered" >          throw assertionError('WriteRecord should have .snap or .children');</span>
        }
      }
    }
    return compoundWrite;
